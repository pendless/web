    ...
    <footer className="text-black dark:text-gray-300 body-font">
      <div className="container flex flex-col items-center px-10 pb-8 mx-auto border-t border-purple-600 dark:border-purple-300 sm:flex-row">
        ...
        <a
          ...
          href={
            router.pathname === "/"
              ? `https://github.com/pendless/web/edit/main/pages/index.js`
              : `https://github.com/pendless/web/edit/main/pages${router.pathname}.js`
          }
        >
        ...
        <span className="inline-flex justify-center mt-4 sm:ml-auto sm:mt-3 sm:justify-start">
          <a
            aria-label="mail"
            href="maito:yo@pendless.fun?subject=From pendless!"
          >
            <svg
              className="w-5 h-5"
              fill="none"
          ...
          <a
            aria-label="twitter"
            className="ml-3"
            href="https://twitter.com/pendless"
          >
            <svg
              fill="currentColor"
              strokeLinecap="round"
          ...
          <a
            ...
            className="ml-3"
            href="https://instagram.com/pendless"
          >
            <svg
              fill="none"
              stroke="currentColor"
          ...
          <a
            aria-label="github"
            className="ml-3"
            href="https://github.com/pendless/web/"
          >
            <svg
              width="30"
              height="20"
